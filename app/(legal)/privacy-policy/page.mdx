# Privacy Policy for GPT-OSS-120B

## Introduction

Welcome to GPT-OSS-120B, the **NextJS Boilerplate** designed to help you build AI SaaS startups quickly and efficiently. At GPT-OSS-120B, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using GPT-OSS-120B:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use GPT-OSS-120B, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access GPT-OSS-120B, such as device type, operating system, and browser type.
